...
export const DESPESA_GRUPOS = [
  ...
  },
  {
    ...
    categorias: [
      'servicos prestados', 'servicos de terceiros', 'honorarios contabeis',
      'software / licenca de uso', 'software', 'comunicacao', 'telefonia e internet',
      'cartorio', 'transporte urbano (taxi, uber)', 'transporte', 'doacao compaixao',
    ],
  },
  {
